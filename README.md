...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lively-mud-8104)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lively-mud-8104
```

A live public deployment of this template is available at [https://lively-mud-8104.templates.workers.dev](https://lively-mud-8104.templates.workers.dev)
